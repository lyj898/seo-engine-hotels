...
- ✅ **SEA full buildout (2026-08-06/07) — COMPLETE, 56/56 hotels.** Final 5 (Siem Reap, Bintan x2, Yogyakarta, Solo) landed in commit `770a209` after the usage limit eased. Catalogue **171 → 227**; 35 cities / 7 countries covering essentially all currently-open Marriott Bonvoy SEA properties. Only remaining follow-up: backfill external_coverage on 3 hotels that shipped coverage-less (`courtyard-phnom-penh`, `four-points-boracay`, `fairfield-cebu-mactan`).
