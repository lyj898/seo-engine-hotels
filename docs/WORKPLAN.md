...
- **Site:** elitestay.travel — programmatic-SEO directory of Marriott Bonvoy hotels across 10 SE-Asia cities spanning 6 countries (Singapore, Bangkok, Phuket, Kuala Lumpur, Bali, Ho Chi Minh City, Jakarta, Penang, Da Nang, Manila). Astro, image-free, tier-coded typographic cards (see `src/lib/brand.js`).
